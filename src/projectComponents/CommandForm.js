...
const CommandForm = ({ handleSubmit, buttonDisable }) => {
  ...
  const [pagination, setPagination] = useState({ skip: 0, take: 2000 });
  ...
  return (
    <Form
      onSubmit={(e) => {
        handleSubmit(e, { key, url, status, pagination, identities, dates });
      }}
    >
      <Form.Group as={Row}>
      ...
      <div style={{ display: filterDisplay ? "" : "none" }}>
        <Form.Row>
          ...
          <Form.Group as={Col}>
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setPagination({ ...pagination, skip: e.target.value });
              }}
              required
            />
          </Form.Group>
          <Form.Group as={Col}>
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setPagination({ ...pagination, take: e.target.value });
              }}
              required
            />
          </Form.Group>
        ...
        <Form.Row>
          <Form.Group as={Col}>
            ...
            <Form.Control
              type="text"
              value={identities.customer}
              onChange={(e) => {
                setIdentities({ ...identities, customer: e.target.value });
              }}
            />
          </Form.Group>
          <Form.Group as={Col}>
            ...
            <Form.Control
              type="text"
              value={identities.agent}
              onChange={(e) => {
                setIdentities({ ...identities, agent: e.target.value });
              }}
          ...
          <Form.Group as={Col}>
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setDates({
                  ...dates,
                  storage: { ...dates.storage, select: e.target.value },
                });
              }}
            >
              <option>{"<"}</option>
          ...
          <Form.Group as={Col}>
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setDates({
                  ...dates,
                  open: { ...dates.open, select: e.target.value },
                });
              }}
            >
              <option>{"<"}</option>
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setDates({
                  ...dates,
                  open: { ...dates.open, date: `${e.target.value}:00.000Z` },
                });
              }}
            />
          </Form.Group>
          ...
          <Form.Group as={Col}>
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setDates({
                  ...dates,
                  status: { ...dates.status, select: e.target.value },
                });
              }}
            >
              <option>{"<"}</option>
